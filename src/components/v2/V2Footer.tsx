      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="mt-2" style={{ fontSize: "1rem", color: "var(--v2-dim)" }}>Phoenix, Arizona</p>
          </div>
            ...
            <ul className="space-y-3">
              {footerLinks.explore.map((l) => (
                <li key={l}>
                  <button
                    onClick={() => handleNav(l)}
                    style={{ fontSize: "1.125rem", color: "var(--v2-dim)", background: "none", border: "none", cursor: "pointer", padding: 0 }}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.partner.map((l) => (
                <li key={l}>
                  <span style={{ fontSize: "1.125rem", color: "var(--v2-dim)" }}>{l}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="mailto:hello@liefdev.com" style={{ fontSize: "1.125rem", color: "var(--v2-dim)", textDecoration: "none" }} className="hover:text-[#00FF88] transition-colors duration-300">
                  hello@liefdev.com
                </a>
              </li>
              <li>
                <a href="#" style={{ fontSize: "1.125rem", color: "var(--v2-dim)", textDecoration: "none" }} className="hover:text-[#00FF88] transition-colors duration-300">
                  LinkedIn
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4" style={{ borderTop: "1px solid var(--v2-rule)" }}>
          <div>
            <p style={{ fontSize: "0.95rem", color: "var(--v2-dim)" }}>© 2026 Lïef Development + Construction</p>
            <p style={{ fontSize: "0.8rem", color: "var(--v2-dim)", opacity: 0.6, marginTop: "4px" }}>A Common Ground venture.</p>
          </div>
          <p style={{ fontSize: "0.8rem", color: "var(--v2-dim)", opacity: 0.5 }}>
