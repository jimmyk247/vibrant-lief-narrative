...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Every project starts with a problem to solve. Not a style to copy. Our design team, led by Scott Meiers with 50+ years across every building type, works in concert with MOR Studio to ground each project in research on how people actually live, work, and move through spaces. We bridge the gap between inspiration and execution with science. The result is considered design: built on evidence, not assumption. That process has produced everything from urban residences to desert modern estates to commercial spaces that perform.",
  },
  {
    question: "Who is behind L\u00efef Development?",
    answer:
      "L\u00efef was built by people who have spent their careers doing the work, not talking about it. Jesse Fowler and Jon Armstrong have delivered $500M+ in projects between them, and that experience shows in how they manage risk, control costs, and keep builds on schedule. Scott Meiers has been designing buildings for over 50 years. There is no building type or challenge he has not worked through, which means fewer surprises and faster solutions when complexity shows up. Jimmy Khounlavong spent 16 years at Nike building some of the most recognized product lines alongside other leading brands before bringing that discipline to how L\u00efef thinks about brand, story, and market position. It is the piece most builders miss. The team is also backed by general counsel, investor relations, and a workforce of 300+ skilled tradesmen.",
  },
];
