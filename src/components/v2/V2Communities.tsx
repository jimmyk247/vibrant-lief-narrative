        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2" style={{ minHeight: "600px" }}>
          ...
          <div ref={osbornRef} className="md:col-span-2 md:row-span-2 relative overflow-hidden group" style={{ minHeight: "500px" }}>
            ...
            <div className="absolute bottom-0 left-0 p-8 md:p-12 z-10">
              ...
              <p className="max-w-md" style={{ fontSize: "0.9rem", color: "var(--v2-muted)", lineHeight: 1.7 }}>
          ...
          <div ref={basinRef} className="relative overflow-hidden group" style={{ minHeight: "280px" }}>
            ...
            <div className="absolute bottom-0 left-0 p-6 z-10">
              ...
              <p style={{ fontSize: "0.85rem", color: "var(--v2-muted)", lineHeight: 1.6 }}>204 units. Integrated model at scale.</p>
          ...
          <div ref={pvRef} className="relative overflow-hidden group" style={{ minHeight: "280px" }}>
            ...
            <div className="absolute bottom-0 left-0 p-6 z-10">
              ...
              <p style={{ fontSize: "0.85rem", color: "var(--v2-muted)", lineHeight: 1.6 }}>Mixed-use redevelopment. Details forthcoming.</p>
            </div>
          </div>
        </div>
      </div>
